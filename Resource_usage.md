...
Home directories are limited to 200 GB of storage. Project space is limited to 250 GB of storage. Scratch storage is limited to 1 TB (2 TB on Easley). Center-wide project scratch space is limited to 3 TB. To purchase additional storage please see our [pricing spreadsheet](https://carc.unm.edu/research/premium-research-computing-services.html).
...
Number of Nodes	|4 (Easley) <br> 2(BigMem) |  8 (Easley) <br> 4 (Bigmem)
Processors per Node |	16(Easley) <br> 32(BigMem)  | 16 (Easley) <br>  32 (BigMem)
