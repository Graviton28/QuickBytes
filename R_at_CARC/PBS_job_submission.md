...
```
yourusername@easley-sn$ qsub my_pbs_script.pbs
```
...
## asking for 48 hours of walltime on the cluster with one node and all cpu's on that node, which for Easley is 8.
#PBS -l walltime=48:00:00
#PBS -l nodes=1:ppn=8
