...
------------------------- ---------------- --------------- -------- - -----
127506.easley-sn.alliance.un pebble30_80      user        288:43:2 R default
127508.easley-sn.alliance.un pebble30_90      user        279:41:4 R default
127509.easley-sn.alliance.un pebble30_70      user        323:06:0 R default
128012.easley-sn.alliance.un canu_easley.sh  user               0 Q default
```
...
Job ID                    Name             User            Time Use S Queue
------------------------- ---------------- --------------- -------- - -----
127506.easley-sn.alliance.un pebble30_80      user        289:04:1 R default
```
...
----------------------- ----------- -------- ---------------- ------ ----- ------ --------- --------- - ---------
127506.easley-sn.alli  user        default  pebble30_80        8739     1      8       --  240:00:00 R 229:13:18
127508.easley-sn.alli  user        default  pebble30_90       25507     1      8       --  240:00:00 R 229:09:10
127509.easley-sn.alli  user        default  pebble30_70       20372     1      8       --  240:00:00 R 229:08:46
128012.easley-sn.alli  user        default  canu_easley.sh     --      1      8      64gb  24:00:00 Q

```
`qstat -f` Specifies a "full" format display of information.  It displays information about job name, owner, CPU time, memory usage, walltime, job status, error and output file paths, executing host, nodes, core allocation, and other details.
`qstat -f  <jobid>` displays the information corresponding to that jobid.
Example

    (user) easley:~$ qstat -f 67048
    Job Id: 67048.easley.easley.alliance.unm.edu
        Job_Name = BipolarCox_138
        Job_Owner = user@easley.easley.alliance.unm.edu
        ...
        job_state = R
        queue = singleGPU
        server = easley.easley.alliance.unm.edu
        Checkpoint = u
        ctime = Mon Feb 18 16:19:19 2019
        Error_Path = easley.easley.alliance.unm.edu:/users/user/experiments/newsui
            cidality-injury/BipolarCox_138.e67048
        exec_host = easley21/0-1
        Hold_Types = n
        Join_Path = n
        Keep_Files = n
        Mail_Points = a
        mtime = Tue Feb 19 12:47:56 2019
        Output_Path = easley.easley.alliance.unm.edu:/users/user/experiments/newsu
        ...
        job_radix = 0
        submit_host = easley.easley.alliance.unm.edu
        request_version = 1

`watch qstat -u <username>` allows an interactive statistics of jobs for that user which updates for every 2sec.  Example

    (user) easley:~$watch qstat -u ceodspsp
    Every 2.0s: qstat -u ceodspsp                                                           Tue Feb 19 13:45:50 2019


    easley.easley.alliance.unm.edu:
                                                                                      Req'd       Req'd       Elap
    Job ID                  Username    Queue    Jobname          SessID  NDS   TSK   Memory      Time    S   Time
    ----------------------- ----------- -------- ---------------- ------ ----- ------ --------- --------- - ---------
    66908.easley.easley.allian  ceodspsp    dualGPU  smoke_1_5        103419     2     32       --   48:00:00 R  21:50:33
    67438.easley.easley.allian  ceodspsp    dualGPU  smoke_5_10        66632     2     32       --   48:00:00 R  09:39:00
...
```bash
qstat -an
easley-sn.alliance.unm.edu:
Job ID                           Username  Queue      Jobname     SessID   NDS  TSK  Memory   Time        S  Time
---------------------------  ------------  --------   ----------  -------  ---  ---  ------  --------    --  --------
55811.easley-sn.alliance.u        user    default    B19F_re5e4        0    4   32     - -  48:00:00     R  47:30:42
      easley296/0-7+easley295/0-7+easley282/0-7+easley280/0-7
```
